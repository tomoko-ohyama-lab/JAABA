function ProcessMWTJAABAData_shua
%% SET MANAULLY
...
%%
addpath(genpath('C:\Users\Ohyama_Dell\Documents\JAABA\JAABA-master\JAABA-master\filehandling'));
addpath(genpath('C:\Users\Ohyama_Dell\Documents\JAABA\JAABA-master\JAABA-master\misc'));
addpath(genpath('C:\Users\Ohyama_Dell\Documents\JAABA\JAABA-master\JAABA-master\spaceTime'));
addpath(genpath('C:\Users\Ohyama_Dell\Documents\JAABA\JAABA-master\JAABA-master\figurecode'));
addpath(genpath('C:\Users\Ohyama_Dell\Documents\JAABA\JAABA-master\JAABA-master\perframe'));
addpath(genpath('C:\Users\Ohyama_Dell\Documents\JAABA\JAABA-master\JAABA-master\FE'));
%%
cd C:\Users\Ohyama_Dell\Documents\JAABA\Processed
if ~exist(genotype,'dir')
    mkdir(genotype)
end
chorelocation=fullfile('C:\Users\Ohyama_Dell\Documents\JAABA\Processed\chore',genotype);
savelocation=fullfile('C:\Users\Ohyama_Dell\Documents\JAABA\Processed',genotype);
classifier='C:\Users\Ohyama_Dell\Documents\JAABA\Classifiers\roll.jab';
...
%     fprintf('DATA Successfully Processed: %s\n',timestamps{i});
    PostProcess_CreateStatFile(genotype,feature,version,chorelocation,timestamps{i},timebins);
    cd(savelocation);
end
