function PostProcess_CreateStatFile_CC(genotype,feature,version,chorelocation,current_timestamp,timebins)
%%
...
switch version
    case 1 %(time1,time2,tsize)
        CreateBinStatFile_CC(allScores,crabspeed,genoInfo,aninum,timebins)
    case 2 %(start,end,rdur)
        CreateIndStatFile_CC(allScores,crabspeed,genoInfo,aninum)
end
