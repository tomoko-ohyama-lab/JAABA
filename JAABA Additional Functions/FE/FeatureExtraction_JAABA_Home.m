...
addpath('C:\Users\noshu\Documents\GitHub\2019-SURA-Project\JAABA Draft\FE')
%% count how many timestamps
genotype_location=fullfile('C:\Users\noshu\Documents\GitHub\2019-SURA-Project\JAABA\Processed',genotype);
...
for i=1:length(timestamps)
    ...
    %% Save the stat.txt
    filename=strcat('C:\Users\noshu\Documents\GitHub\2019-SURA-Project\feature_extraction\',tracker,'\',driver,'@',effector,'\',protocol,'@100\',timestamp,'\',FEname);
...
%% Save pool file
filename=strcat('C:\Users\noshu\Documents\GitHub\2019-SURA-Project\feature_extraction\',tracker,'\',driver,'@',effector,'\',protocol,'@100\',FEname);
fileID=fopen(filename,'w');
fprintf(fileID,'%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\r\n','time_stamp','animal','time1','time2','rampl','rdur','rpos','rbeg','tsize');
for j=1:length(pool)
    fprintf(fileID,'%s\r\n',strarray{j});
